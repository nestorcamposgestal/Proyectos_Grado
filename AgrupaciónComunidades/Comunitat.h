...
public:
	...
	void generaDendrogram(int pos1, int pos2, double deltaQp1p2);//añadida
	...
	//Funciones a mayores
	void setComunidadesActivas(int comAct) { m_comunidadesActivas = comAct; }
	void calculaPosicion(int &pos1, int &pos2);
	void calculaVei(int &posVei);
...
private:
	...
	//Variables añadidas a mayores
	int m_comunidadesActivas;
	double m_incrementoQ;
	int m_PrimeraPosicionDeltaQ;
