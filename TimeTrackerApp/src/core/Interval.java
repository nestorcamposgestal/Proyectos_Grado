...
public class Interval implements Observer{
    ...
    Interval(Task tarea_padre, JSONObject json_loader){
        ...
        m_init_DateTime_i = LocalDateTime.parse(json_loader.getString("initialDate"));
        m_end_DateTime_i = LocalDateTime.parse(json_loader.getString("finalDate"));
    ...
    public JSONObject createJSON(){
        ...
        m_json_interval.put("id", m_id);
        m_json_interval.put("class", m_class);
        m_json_interval.put("initialDate", Utils.format_localdatetime(m_init_DateTime_i));
        m_json_interval.put("finalDate", Utils.format_localdatetime(m_end_DateTime_i));
        m_json_interval.put("duration", m_duration_i.toSeconds());
