...
public class Main{
    ...
    public static void TestC_TotalTime() throws IOException, InterruptedException {
        ...
        Project active_root = new Project("Active tasks"); // ID 1

        Project p0 = root.createProject("P0"); // ID 2

        Project p1 = root.createProject("P1"); // ID 3

        Project p3 = root.createProject("P3"); // ID 4

        Task t0 = p0.createTask("T0"); // ID 5
        Task t1 = p0.createTask("T1"); // ID 6
        Task t2 = p0.createTask("T2"); // ID 7

        Task t3 = p1.createTask("T3"); // ID 8

        Task t4 = root.createTask("T4"); // ID 9
        Task t5 = root.createTask("T5"); // ID 10
