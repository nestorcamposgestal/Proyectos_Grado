...
// --Commented out by Inspection STOP (03/11/2020 19:23)
    ...
    public JSONObject createJSON(){
        ...
        m_json_task.put("initialDate", Utils.format_localdatetime(m_init_DateTime_e));
        m_json_task.put("finalDate", Utils.format_localdatetime(m_end_DateTime_e));
        m_json_task.put("duration", m_duration_e.toSeconds());
        ...
        if (m_tag_array != null) {
            ...
            m_json_task.put("tags", m_json_tags);
        }
    ...
    @Override
    public void setM_element_array(Vector<Element> active_tasks) { }
