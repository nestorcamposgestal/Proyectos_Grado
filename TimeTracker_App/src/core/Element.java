...
public abstract class Element implements IterableCollection {
    ...
    public abstract Vector<Element> findActiveTasks();
    public abstract Element getActiveTasksRoot(Vector<Element> active_tasks);

    public abstract void setM_element_array(Vector<Element> active_tasks);
