...
public class Utils {
    ...
    public static String format_localdatetime(LocalDateTime time){
    ...
    public static Duration TotalTime_calculation(TotalTime it){
        ...
        for (Element e: pair_map.keySet()){
            if (e.getM_project().getM_id() == 0) // Se coge el tiempo del root
    ...
    public static Map<Element, Duration> TotalTime(TotalTime it) {
        ...
        if ((it.getM_element().getM_end_DateTime_e() != null) && (it.getM_element().getM_init_DateTime_e() != null) && (it.getM_element().getDuration() != Duration.ZERO))
